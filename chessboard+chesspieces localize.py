...
fen_notation = ""  # Initialize FEN notation
...
while True:
    ...
    if board_contour is not None:
        ...
        frame, warped, piece_positions = detect_chess_pieces(frame, warped, start_x, start_y, square_size)

        # Update FEN notation if a piece has moved
        new_fen_notation = generate_fen_notation(piece_positions)
        if new_fen_notation != fen_notation:
            fen_notation = new_fen_notation
